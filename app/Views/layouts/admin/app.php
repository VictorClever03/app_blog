...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?=  ucwords($title) == ('Novo Post') || ucwords($title) == ('Post') || ucwords($title) == ('Categorias') || ucwords($title) == ('Posts')  ? '' : 'collapsed' ?>" data-bs-target="#posts-nav" data-bs-toggle="collapse" href="#">
        ...
        <ul id="posts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?=URL?>/admin/posts/create" class="<?= ucwords($title) == ('Novo Post') ? 'active' : '' ?>">
              <i class="bi bi-circle"></i><span>Novo</span>
            </a>
          </li>
          <li>
            <a href="<?=URL?>/admin/posts" class="<?= ucwords($title) == ('Posts') ? 'active' : '' ?>">
              <i class="bi bi-circle"></i><span>Listar</span>
            </a>
          </li>
          <li>
            <a href="<?=URL?>/admin/categorias" class="<?=  ucwords($title) == ('Categorias') ? 'active' : '' ?>">
