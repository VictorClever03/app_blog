        ...
        <div class="col-xl-4">
          ...
          <form action="" method="post" >
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="exampleInputText1" aria-describedby="textHelp" placeholder="ex: Ezequiel Ribeiro">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="exampleInputText1" aria-describedby="textHelp" placeholder="ex: Ezequiel@gmail.com">
              <div id="textHelp" class="invalid-feedback">We'll never share your texts with anyone else.</div>
            </div>
            <div class="mb-3">
            ...
            <div class="text-center"><button type="submit" class="btn-get-started border-0 ">Criar</button></div>
          </form>
        </div>
